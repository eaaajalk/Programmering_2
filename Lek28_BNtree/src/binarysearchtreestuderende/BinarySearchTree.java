...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    //privat hjælpemetode inorder til toArray
    private ArrayList<E> toArray (Node n, ArrayList<E> list) {
        if (n != null) {
            toArray(n.left, list);
            list.add(n.data);
    ...
    // Returnerer en sorteret array med indhold
    public Object[] toArray() {
        ArrayList<E> list = new ArrayList<>();
        return toArray(root, list).toArray();
    }
    ...
    private class Node {
        ...
        // log n hvis det er velafbalanceret ellers n
