...
public class Gui extends Application {
	...
	public static void updateTreasureOnScreen() {
		Platform.runLater(() -> {
		for (int i=0;i<GameLogic.treasures.size();i++) {
			fields[GameLogic.treasures.get(i).getLocation().getX()][GameLogic.treasures.get(i).getLocation().getY()].setGraphic(new ImageView(treasure));
		}
	});
	}
	public static void removeTreasureOnScreen() {
	...
	public void playerMoved(int delta_x, int delta_y, String direction) {
		...
		updateScoreTable();
		gameClient.sendPlayerData(GameLogic.getMe());
	}
	...
	public void exitGame() throws IOException {
		gameClient.exitGame(GameLogic.getMe().getName());
		System.exit(0);
